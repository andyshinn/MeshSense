  ...
  makers: [
    ...
    new MakerDeb({
      options: {
        ...
        description: 'MeshSense is a simple, open-source application that monitors, maps and graphically displays all the vital stats of your area\'s Meshtastic network',
