...
export const modalPage = writable("Settings")
...
<script>
  ...
  import SystemLog from './settings/SystemLog.svelte'
  import DeviceConfig from './settings/DeviceConfig.svelte'
  import Channels from './settings/Channels.svelte'
